...
import com.zamzam.chat.attachments.MmsNotificationAttachment;
import com.zamzam.chat.contactshare.Contact;
import com.zamzam.chat.database.documents.IdentityKeyMismatch;
import com.zamzam.chat.database.documents.IdentityKeyMismatchList;
import com.zamzam.chat.database.documents.NetworkFailure;
import com.zamzam.chat.database.documents.NetworkFailureList;
...
import com.zamzam.chat.database.model.NotificationMmsMessageRecord;
...
import com.zamzam.chat.mms.MessageGroupContext;
...
import com.zamzam.chat.revealable.ViewOnceExpirationInfo;
...
import static com.zamzam.chat.contactshare.Contact.Avatar;
...
//  }
  ...
  public void markIncomingNotificationReceived(long threadId) {
    ...
    if (com.zamzam.chat.util.Util.isDefaultSmsProvider(context)) {
      DatabaseFactory.getThreadDatabase(context).incrementUnread(threadId, 1);
    }
  ...
  public class Reader implements Closeable {
    ...
    private NotificationMmsMessageRecord getNotificationMmsMessageRecord(Cursor cursor) {
      ...
      if (!TextUtils.isEmpty(contentLocation))
        contentLocationBytes = com.zamzam.chat.util.Util.toIsoBytes(contentLocation);

      if (!TextUtils.isEmpty(transactionId))
        transactionIdBytes = com.zamzam.chat.util.Util.toIsoBytes(transactionId);
