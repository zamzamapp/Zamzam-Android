...
import com.zamzam.chat.database.SmsMigrator;
import com.zamzam.chat.database.SmsMigrator.ProgressDescription;
import com.zamzam.chat.notifications.NotificationChannels;
import com.zamzam.chat.notifications.NotificationIds;
    ...
    implements SmsMigrator.SmsMigrationProgressListener
{
  ...
  public  static final String MIGRATE_DATABASE  = "com.zamzam.chat.ApplicationMigration.MIGRATE_DATABSE";
  public  static final String COMPLETED_ACTION  = "com.zamzam.chat.ApplicationMigrationService.COMPLETED";
