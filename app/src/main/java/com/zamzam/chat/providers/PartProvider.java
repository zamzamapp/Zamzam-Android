...
import com.zamzam.chat.util.MemoryFileUtil;
...
public class PartProvider extends ContentProvider {
  ...
  private static final String CONTENT_URI_STRING = "content://org.thoughtcrime.provider.chat/part";
  ...
  static {
    ...
    uriMatcher.addURI("org.thoughtcrime.provider.chat", "part/*/#", SINGLE_ROW);
  }
