package com.zamzam.chat.providers;
...
import com.zamzam.chat.video.ByteArrayMediaDataSource;
...
public class BlobProvider {
  ...
  public static final Uri        CONTENT_URI = Uri.parse("content://com.zamzam.chat/blob");
  public static final String     AUTHORITY   = "com.zamzam.chat";
