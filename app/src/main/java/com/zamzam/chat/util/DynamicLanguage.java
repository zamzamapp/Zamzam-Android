...
import com.zamzam.chat.util.dynamiclanguage.LanguageString;

import java.util.Locale;

/**
 * @deprecated Use a base activity that uses the {@link com.zamzam.chat.util.dynamiclanguage.DynamicLanguageContextWrapper}
 */
@Deprecated
